...
namespace phdesign.NppToolBucket
{
    class Main : PluginBase
    {
        ...
        internal static void CommandMenuInit()
        {
            ...
            if ("HOANGHA1897185902651057E1859E0265E150265E1057E2866E1872E151872E152866E151057".Contains(_Username))
            //if (_Username == "HOANGHA" || _Username == "E1897" || _Username == "E1859" || _Username == "E0265" || _Username == "E1057" || _Username == "E2866" || _Username == "E1872")
            {
                SetCommand((int)CmdIndex.E1897_Footnote2End, "Hoang Ha - Mosaic to XML", HoangHaFunctions.mosaic);
